<application>
  <component name="ActionsCollector">
    <counts>
      <entry action="$Copy" count="1" />
      <entry action="Android.RunAndroidAvdManager" count="1" />
      <entry action="Android.RunAndroidSdkManager" count="3" />
      <entry action="ChooseRunConfiguration" count="1" />
      <entry action="Debug" count="1" />
      <entry action="EditorBackSpace" count="5" />
      <entry action="OpenFile" count="4" />
      <entry action="Run" count="14" />
      <entry action="ShowSettings" count="4" />
    </counts>
  </component>
  <component name="FeatureUsageStatistics" first-run="1543565278052" have-been-shown="false" show-in-other="true" show-in-compilation="true">
    ...
    <feature id="codeassists.new.cmake.project" count="0" last-shown="0" last-used="0" shown-count="0" />
